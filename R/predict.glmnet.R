...
#'
#' @aliases coef.glmnet coef.relaxed predict.glmnet predict.relaxed predict.elnet predict.lognet predict.multnet predict.mrelnet predict.fishnet
...
#' predictors for \code{"binomial"}, \code{"multinomial"}, \code{"poisson"} 
